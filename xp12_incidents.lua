...
def("SMOKE",          "sim/operation/failures/rel_smoke_cpit",       "Smoke",        "engine_or_elec", nil, { cond = smoke_fixable, hold = 0, _t = nil })
...
def("ELV_TRIM_RUN",   "sim/operation/failures/rel_elv_trim_run",      "Elv Trim Run", nil, nil, { cond = trim_fixable, hold = 0, _t = nil, followup = { "TRIM_ELV", "TRIM_AIL", "TRIM_RUD" } })
def("AIL_TRIM_RUN",   "sim/operation/failures/rel_ail_trim_run",      "Ail Trim Run", nil, nil, { cond = trim_fixable, hold = 0, _t = nil, followup = { "TRIM_ELV", "TRIM_AIL", "TRIM_RUD" } })
def("RUD_TRIM_RUN",   "sim/operation/failures/rel_rud_trim_run",      "Rud Trim Run", nil, nil, { cond = trim_fixable, hold = 0, _t = nil, followup = { "TRIM_ELV", "TRIM_AIL", "TRIM_RUD" } })
